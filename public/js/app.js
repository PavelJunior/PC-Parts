...
var selectedId = null;
var buttons = document.getElementsByClassName('contact-btn');
...
function submitContactForm(type) {
  ...
  xhr.send(formData);
  var modal = bootstrap.Modal.getInstance(document.getElementById('contact-form-modal')); // relatedTarget
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (params.has('categories')) {
    var categories = params.get('categories').split(',');
    var inputs = document.getElementsByClassName('filter-category');
